...
--working-directory /home/atomicjolt/projects/offline-tracker \
-e 'env PROMPT_COMMAND="unset PROMPT_COMMAND; history -s bundle\ exec\ rails\ s\ -p3070; bundle exec rails s -p3070" bash' \
--tab -T que \
--working-directory /home/atomicjolt/projects/offline-tracker \
